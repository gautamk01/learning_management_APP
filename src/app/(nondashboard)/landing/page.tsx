    ...
    return (
        ...
        >
            ...
            <motion.div
                ...
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.5 }}
                viewport={{ amount: 0.3, once: true }} // determin when it will get animated
                className="landing__featured"
            >
                <h2 className="landing__featured-title">Featured Course</h2>
                <p className="landing__featured-description">
                    From beginer to advanced, in all industries , we have the right
                    courses just for you and prepare your entire journey for learning and
                    making the most.
                </p>
